...
public class MailInfoThread  implements Runnable{
	...
	MailData _mail;
	Object _param;
	public MailInfoThread(MailData mail) {
		this._mail = mail;
		//this.sendMail(mail);
	}
	
	public <T>MailInfoThread(MailData mail, T data) {
		this._mail = mail;
		this._param = data;
	}
	...
	public void run() {
		...
		this.sendMail(this._mail,this._mail);
	}

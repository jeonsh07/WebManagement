    ...
    <v-container>
      <v-app-bar app flat clipped-left v-if="isShowBar" color="white">
        ...
        <v-menu left bottom class="pa-0" :offset-y="true">
          ...
          <v-list>
            ...
            <v-list-item>
              <v-list-item-title v-text="'프로필'" />
            </v-list-item>
            <v-list-item>
              <v-list-item-title v-text="'북마크'" />
            </v-list-item>
            <v-divider />
            <v-list-item
      ...
      >
            ...
            >
              <template v-slot:activator>
                <v-list-item-action class="mr-3">
                  <em v-if="item.menu_icon !== ''" :class="item.menu_icon" />
                </v-list-item-action>
                <v-list-item-title>
                  {{ item.menu_name }}
                </v-list-item-title>
        ...
        <v-list dense>
          ...
          <v-list-item
            link
            @click="$BaseCommon.MemberInfo.moveLogin('local')"
            v-if="!isLogin"
          >
            <v-list-item-action class="mr-3">
        ...
        if (menuList[i].menu_level === 1) {
          ...
          if (
            list[chkIndex].children.filter(
              (w) => w.menu_code === menuList[i].menu_code
            ).length === 0
          )

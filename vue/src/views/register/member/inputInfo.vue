  ...
  <v-container class="pa-0">
    <v-col offset-sm="1">
      <v-form ref="inputForm">
        ...
        <v-row justify="start" no-gutters>
          <v-col class="d-flex justify-start" cols="12" sm="3" lg="2">
            <span class="text-left"
              >닉네임<span class="d-flex" style="font-size:0.75em;"
                >(로컬사업자명)</span
              ></span
            >
          </v-col>
          <v-col cols="12" sm="5" lg="4">
            <v-text-field
              placeholder="한글/영문 사용(공백,특수문자 불가)"
              v-model="nickName"
              :rules="[nickRules]"
              maxlength="12"
              filled
          ...
          >
            <v-btn
              ...
              text
              height="2.7em"
              @click="dupMemConfirm(confirmNick, info.nickName)"
            >
              중복확인
            </v-btn>
          </v-col>
        ...
        <v-row justify="start" no-gutters>
          ...
          <v-col
            class="d-flex justify-end justify-sm-start justify-lg-start ml-sm-3 mt-sm-3 mt-lg-0"
            cols="12"
            sm="2"
          >
            <v-btn
              ...
              text
              height="2.7em"
              @click="dupMemConfirm(confirmId, info.id)"
            >
              중복확인
            </v-btn>
          </v-col>
...
export default {
  ...
  data() {
    return {
      ...
      nickRules: () => {
        return this.checkNick(this.info.nickName, this.confirmNick)
      },
      emailIdRules: () => {
  ...
  methods: {
    ...
    checkMemDup() {
      const dupArr = [this.confirmNick, this.confirmId]
